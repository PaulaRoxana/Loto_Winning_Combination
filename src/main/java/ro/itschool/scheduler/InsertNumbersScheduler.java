...
public class InsertNumbersScheduler {
    ...
    public void insertWinningCombination() {
        ...
        //Get all combinations from the other (Ticket) app (if not obsolete)
...
//Insert winning combination: WinningCombination(id=8, winningNumbers=17,39,40,28,45,29, insertTime=2023-03-23T23:00:00.004127800)
//All tickets: [Ticket(id=9, winningNumbers=37,1,6,9,3,31, insertTime=2023-03-23T22:59:16, buyer=SOME Buyer)]
